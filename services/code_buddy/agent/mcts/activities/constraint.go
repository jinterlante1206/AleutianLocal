...
func (a *ConstraintActivity) Execute(
	...
	ctx, span := otel.Tracer("activities").Start(ctx, "activities.ConstraintActivity.Execute",
	...
	span.SetAttributes(attribute.String("operation", constraintInput.Operation))
